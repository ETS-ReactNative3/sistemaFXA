...
import logoFXA from '../../assets/images/certificado/version_firma.png'
import footer from '../../assets/images/certificado/FooterPdf.png'
import { EmpleadoService } from '../../service/EmpleadoService';
import { NumerosALetras, ObtenerMes } from 'numero-a-letras/build/numeroaletrasYmeses' 
...
const formatterPeso = new Intl.NumberFormat('es-CO', {
  ...
  const GeneratePdf = () =>{
        ...
        doc.addImage(logoFXA,'png',480,10)
